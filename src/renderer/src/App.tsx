...
function App(): React.JSX.Element {
      ...
      try {
        ...
        if (!cancelled) {
          ...
          timeRendererStartupSyncStep('hydrate-session-stores', () => {
            ...
            // [FORK] Bookmarks hydrate alongside the other session stores.
            actions.hydrateBookmarks(sessionRead.session)
          })
  ...
  // Задачи-рядом-с-чатом живут во вкладке (openTasksEditorTab), а не в
  // полноэкранном вью 'tasks' — тому оставляем апстримную distraction-free форму.
