        ...
        {target ? (
          showTerminal ? (
            ...
            <NativeChatView
              ...
              // [FORK] Cursor-раскладка: «проект ▾ ветка ▾ где ▾» под композером,
              // а не над всей панелью (worktree/ветку менять поздно после запуска).
              footerWorktreeId={activeWorktreeId}
            />
          )
        ) : activeWorktreeId ? (
